...
public class VentanaPrincipal {
	...
	// Hacemos esto para que podamos cambiar despu茅s los componentes por otros
	JPanel[][] panelesJuego;
	...
	// Constructor, marca el tama帽o y el cierre del frame
	...
	/**
	 * Metodo que inicializa todos los l铆steners que necesita inicialmente el
	 * programa
	 */
	 ...
	 * boton que haya en la celda determinada y a馻de un JLabel centrado y no
	 ...
	 * @param j:
	 *            posici贸n horizontal de la celda.
	 */
	...
	/**
	 * Metodo que muestra la puntuaci贸n por pantalla.
	 */
	...
	/**
	 * A馻dimos un listener al boton de Dentro del panel de Dificultad en el que
	...
	/**
	 * Metodo que al explotar una bomba nos ense馻 las bombas que habia en el
	 * tablero
	 */
